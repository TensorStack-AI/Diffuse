...
namespace Diffuse.Views
{
    ...
    public partial class ImageToImageView : ViewBase
    {
        ...
        public ImageToImageView(Settings settings, NavigationService navigationService, IEnvironmentService environmentService, IDiffusionService diffusionService, IExtractorService extractorService, IUpscaleService upscaleService, IHistoryService historyService, ILogger<ImageToImageView> logger)
        ...
        private async Task ExecuteAsync()
        {
            ...
            try
            {
                ...
                // History
                await HistoryService.AddAsync(ResultImage, View.ImageToImage, _options);
