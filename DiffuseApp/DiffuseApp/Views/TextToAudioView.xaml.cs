...
namespace Diffuse.Views
{
    ...
    public partial class TextToAudioView : ViewBaseModel
    {
        ...
        /// </summary>
        public TextToAudioView(Settings settings, NavigationService navigationService, IEnvironmentService environmentService, IHistoryService historyService, Services.IAudioService audioService, ILogger<TextToAudioView> logger)
