...
namespace Diffuse.Common
{
    public record SchedulerInputOptions : BaseRecord
    {
        ...
        private int _numTrainTimesteps = 1000;
        ...
        private float _clipSampleRange = 1.0f;
        private float _sampleMaxValue = 1.0f;
        private bool _thresholding = false;
        private float _dynamicThresholdingRatio = 0.995f;
        ...
        private float _baseShift = 0.5f;
        private float _maxShift = 1.15f;
        private float? _shiftTerminal;
        private bool _useDynamicShifting;
        private float _flowShift = 1;
        private float _sNRShiftScale;
        private TimeShiftType _timeShiftType;
        private float _rho = 7.0f;
        private int _solverOrder = 2;
        private SolverType _solverType = SolverType.Midpoint;
        private AlgorithmType _algorithmType = AlgorithmType.DPMSolverPlus;
        private bool _lowerOrderFinal = true;
        private bool _stochasticSampling;
        private float _eta = 0.0f;
        private float _sNoise = 1.0f;
